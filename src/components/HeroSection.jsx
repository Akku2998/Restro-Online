...
const Frontpage = () => {
  return (
    <div className="w-full h-screen bg-fff5ec m-6">
      <nav className="flex items-center justify-between">
        ...
        <div className="icon relative z-50 right-20 top-5 flex items-center">
          <a
            href="#"
            className="user bg-white text-black text-xl w-9 h-9 rounded-full flex items-center justify-center"
          >
            <img
              src="./userpic.png"
              alt="User"
      ...
      <div className="content flex justify-between">
        <div className="left w-1/2 ml-10 mt-20">
          ...
          <h3 className="text-5xl font-bold text-purple-900 leading-tight">
            Discover Restaurant
            <br /> & Delicious Food
          </h3>
          <form className="mt-8 flex">
            <input
              ...
              className="w-full py-3 px-4 bg-transparent border border-gray-300 text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
            />
            <input
              type="submit"
              value="GO"
              className="bg-teal-600 text-white font-semibold py-3 px-6 ml-2 rounded-full cursor-pointer"
            />
          </form>
        </div>
        <img
